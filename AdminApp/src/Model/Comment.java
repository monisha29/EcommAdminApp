...
public class Comment {
   ...
   public static  List<Comment> fetchAllUnprocessedComments(String productId)
   {
   	List<Comment> listOfComments = new ArrayList<Comment>();
   	JSONObject parameterJson= new JSONObject();
   	parameterJson.put(CommentContract.COMMENTPRODUCTID,productId);
   	String commentJson = DBFunctions.fetchDocumentsWithQueryParameter(CommentContract.COMMENTTABLENAME,parameterJson);
   	listOfComments = CommentContract.parseProductJson(commentJson);
   	return listOfComments;
   }
}
