...
public class Credentials {
	    ...
	    public static String getAdressString(String collection_name,JSONObject queryparameter)
	    {
	        String url = String.format(base_url+"/collections/%s?q=%s",collection_name,queryparameter);
	        StringBuilder stringBuilder = new StringBuilder(url);
	        stringBuilder.append("&apiKey="+API_KEY);
	        return stringBuilder.toString();
	    }
