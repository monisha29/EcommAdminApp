...
//		in.close();
	...
	public static String fetchDocumentsWithQueryParameter(String collection,JSONObject parameter)
	{
	    String op = "failed";
	    try {
	      //  String condition = "{\"jobid\":\"59facf8df36d28650ac24e39\"}";
	       
	        String urlString = Credentials.getAdressString(collection, parameter);
	        URL url = new URL(urlString);
